/*
  ...
  Outputs:  8 channel(s) of optocoupler relay modules, wired
...
uint8_t RelayPins[NUM_RELAYS] = {4, 13, 14, 16, 17, 18, 19, 21};
...
unsigned long RelayStartTime[NUM_RELAYS] = {0, 0, 8, 12, 0, 15, 20, 0};
unsigned long RelayStopTime[NUM_RELAYS]  = {10, 20, 25, 18, 0, 35, 40, 0};
