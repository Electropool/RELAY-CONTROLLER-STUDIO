/*
  ...
  Outputs:  2 channel(s) of optocoupler relay modules
  ----------------------------------------------------------------------------
  DESCRIPTION
...
unsigned long TOTAL_TIME_SECONDS = 15;
...
uint8_t RelayPin[NUM_RELAYS] = {4, 5};
...
RelayEvent relayEvents[NUM_RELAYS][MAX_EVENTS_PER_RELAY] = {
  { {0, 5, false, 1000}, {10, 15, true, 200}, {0, 0, false, 1000} },
  { {0, 5, true, 800}, {10, 15, false, 1000}, {0, 0, false, 1000} }
};
